...
public class ViewerPanel_Batch extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        canvas3 = new cz.fidentis.gui.Canvas();
        canvas4 = new cz.fidentis.gui.Canvas();
    ...
    private void canvas4MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_canvas4MousePressed
        mouseDraggedX = evt.getX();
        mouseDraggedY = evt.getY();
    ...
    }//GEN-LAST:event_canvas4MousePressed

    private void canvas4MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_canvas4MouseReleased
        manipulatePoint = false;
        dragging = false;
        if (selection && SwingUtilities.isLeftMouseButton(evt)) {
    ...
    }//GEN-LAST:event_canvas4MouseReleased

    private void canvas4MouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_canvas4MouseDragged
        if (SwingUtilities.isLeftMouseButton(evt)) {
            if (selection) {
                listener.setSelectionEnd(evt.getPoint(), canvas4.getWidth(), canvas4.getHeight());
            } else {
    ...
    }//GEN-LAST:event_canvas4MouseDragged

    private void canvas4MouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_canvas4MouseWheelMoved
        if (evt.getWheelRotation() > 0) {
            listener.zoomIn(-5 * evt.getWheelRotation());
        } else {
            listener.zoomOut(5 * evt.getWheelRotation());
    ...
    }//GEN-LAST:event_canvas4MouseWheelMoved

    // private JSplitPane jSplitPane1;
    // private Canvas canvas2;
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private cz.fidentis.gui.Canvas canvas1;
    private cz.fidentis.gui.Canvas canvas3;
    private cz.fidentis.gui.Canvas canvas4;
