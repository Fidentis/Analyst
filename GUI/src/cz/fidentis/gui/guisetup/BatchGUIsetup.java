...
public class BatchGUIsetup {
   ...
   private static final int AVG_FACES = 3;
   private static final int AVG_FACE_INDEX = -1;
   ...
   public static void setUpDefaultRegistrationData(BatchComparison data){
       ...
       data.setICPnumberOfHeads(AVG_FACES);
       data.setTemplateIndex(AVG_FACE_INDEX);
   ...
   //set data for 1:N comparison results
    public static void defaultValuesComparisonResults(BatchComparison data){
